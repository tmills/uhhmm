...
argparser.add_argument('-F', '--alphafj', dest='alphafj', action='store', default=1.0, help='Hyperparameter for the FJ model')
argparser.add_argument('-A', '--alphaa', dest='alphaa', action='store', default=1.0, help='Hyperparameter for the A model')
argparser.add_argument('-B', '--alphab', dest='alphab', action='store', default=1.0, help='Hyperparameter for the B model')
argparser.add_argument('-G', '--alphag', dest='alphag', action='store', default=1.0, help='Hyperparameter for the G model')
argparser.add_argument('-H', '--alphah', dest='alphah', action='store', default=1.0, help='Hyperparameter for the lex model')
argparser.add_argument('-gam', '--gamma', dest='gamma', action='store', default=1.0, help='Gamma')
argparser.add_argument('-c', '--decay', dest='decay', action='store', default=1.0, help='Model decay')
argparser.add_argument('-L', '--global_cts', dest='global_cts', action='store_true', help='Use global counts for model resampling')
...
print('alphafj=' + str(args.alphafj))
print('alphah=' + str(args.alphah))
print('gamma=' + str(args.gamma))
print('decay=' + str(args.decay))
print('from_global_counts=' + str(int(args.global_cts)))

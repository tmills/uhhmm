...
argparser.add_argument('-T', '--termination', dest='termination', default=None, action='store', help='Branch termination (bottom-out) probability. 0 < termination <= 1. Termination can be specified as a single scalar, a range of scalars "start:end" (in which case a step size of 0.1 will be used), or a range with a step specification "start:step:end". If left unspecified, defaults to <None>, and termination probability will be determined empirically (relative number of non-terminating rules).')

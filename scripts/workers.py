...
def main(args):
    ...
    if len(args) >= 8:
        ...
        processes = start_local_workers(args[0], int(args[1]), int(args[2]), int(args[3]), int(args[4]), num_workers, bool(args[5]), int(args[6]))
...
#             p.start()
        ...
        start_local_workers(args[0], int(args[1]), int(args[2]), int(args[3]), int(args[4]), 1, bool(args[5]), int(args[6]))
